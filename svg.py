...
class SVG(object):
    ...
    def __generate_templates(self):
        ...
        templates["rectangle"] = "    <rect fill='{}' stroke='{}' stroke-width='{}px' width='{}' height='{}' y='{}' x='{}' ry='{}' rx='{}' opacity='{}'  transform='rotate{}' />\n"
    ...
    def rectangle(self, width, height, x, y, fill, stroke, strokewidth, radiusx, radiusy, opacity=1, transform=(0,0,0)):
        self.__add_to_svg(self.templates["rectangle"].format(fill, stroke, strokewidth, width, height, y, x, radiusy, radiusx, opacity, transform))
